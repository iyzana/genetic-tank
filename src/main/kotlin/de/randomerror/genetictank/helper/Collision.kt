...
class RotatedRectangle(x: Double, y: Double, width: Double, height: Double, rotation: Double) {
    ...
    val outline = Rectangle(area.bounds2D.x, area.bounds2D.y, area.bounds2D.width, area.bounds2D.height)
